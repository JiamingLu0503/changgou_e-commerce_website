...
public class AreasController {
    ...
    public Result<PageInfo> findPage(@RequestBody(required = false) @ApiParam(name = "Areas对象",value = "传入JSON数据",required = false)
                                             Areas areas, @PathVariable  int page, @PathVariable  int size){
