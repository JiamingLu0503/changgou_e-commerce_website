...
public class CitiesController {
    ...
    public Result<PageInfo> findPage(@RequestBody(required = false) @ApiParam(name = "Cities对象",value = "传入JSON数据",required = false)
                                             Cities cities, @PathVariable  int page, @PathVariable  int size){
