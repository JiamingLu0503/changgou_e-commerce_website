...
public class ProvincesController {
    ...
    public Result<PageInfo> findPage(@RequestBody(required = false) @ApiParam(name = "Provinces对象",value = "传入JSON数据",required = false)
                                             Provinces provinces, @PathVariable  int page, @PathVariable  int size){
