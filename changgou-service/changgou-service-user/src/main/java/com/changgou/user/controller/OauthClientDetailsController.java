...
public class OauthClientDetailsController {
    ...
    public Result<PageInfo> findPage(@RequestBody(required = false) @ApiParam(name = "OauthClientDetails对象",value = "传入JSON数据",required = false)
                                             OauthClientDetails oauthClientDetails, @PathVariable  int page, @PathVariable  int size){
